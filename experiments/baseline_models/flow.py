# pytype: skip-file
"""
This module defines two types of neural flows: CouplingFlow and ResNetFlow.
These flows are used for transforming data through a series of neural network
layers, with support for time embedding and invertibility.
"""
    ...
    for i in range(n_layers):
      transforms.append(
          st.ContinuousAffineCoupling(
              ...
              time_net=getattr(st.net, time_net)(2 * dim,
...
class ResNetFlow(Module):
  """
    ...
    Args:
        ...
        time_net: Time embedding module
        time_hidden_dim: Time embedding hidden dimension
        invertible: Whether to make ResNet invertible (necessary for proper
          flow)
    """
